 ...
 */
__maybe_unused static int boot_from_devices(struct spl_image_info *spl_image,
...
#endif
/* ---------------------------------------------------------------------------*/
/* ------------------------- Functions Copied from spl_ymodem.c --------------*/
/* ---------------------------------------------------------------------------*/
#include <common.h>
#include <gzip.h>
#include <image.h>
...
// Function copied from spl_ymodem.c
...
void board_init_r(gd_t *dummy1, ulong dummy2)
{
	...
	ret = spl_ymodem_load_image(&spl_image,NULL);
